...
![How function calling works in gemini](https://raw.githubusercontent.com/sunilcomposio/notion-to-github/main/images/Google-Gemini-3-Exploring-Function-Calling-Tool-Use/image_1.png)
...
1. You send tool results back to Gemini
  ...
  - However, in most cases, developers have to pass the results and the original conversation. You can refer to the official [Gemini docs](https://ai.google.dev/gemini-api/docs/function-calling) to learn more.
...
- Head to [Composio ](https://platform.composio.dev/auth), either login/signup
...
![Image 2](https://raw.githubusercontent.com/sunilcomposio/notion-to-github/main/images/Google-Gemini-3-Exploring-Function-Calling-Tool-Use/image_2.png)
...
![Image 3](https://raw.githubusercontent.com/sunilcomposio/notion-to-github/main/images/Google-Gemini-3-Exploring-Function-Calling-Tool-Use/image_3.png)
...
[Google ADK](https://developers.googleblog.com/en/agent-development-kit-easy-to-build-multi-agent-applications/) (Agent Development Kit) is Google’s opinionated framework for building full-blown agents.  
...
But it’s limited in terms of tools, and for cross-application workflows, you’ll need to build integrations. However, creating these can take an eternity; if it’s not central to your core product, you can use[ Composio toolkits](https://composio.dev/toolkits). We also have an even better abstraction, Tool Router.

[Tool Router MCP](https://composio.dev/blog/introducing-tool-router-(beta)) is a unified interface that lets an agent **search**, **plan**, **authenticate**, and **execute** actions across thousands of [Composio tools](https://composio.dev/toolkits). This means less thinking, more building. 
...
- Add the respective `GOOGLE_API_KEY` key when prompted. Get it from [Google Studio](https://aistudio.google.com/api-keys).
