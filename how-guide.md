...
You can learn more about OAuth scopes in the [Zoho API documentation](https://www.zoho.com/crm/developer/docs/api/v8/select-api-scopes.html).
...
## **Step 5: Connect you Zoho account**

**connect** to zoho by clicking on connect acccount and enter your zoho region, and accept permissions which have asked 
